                ...
                <div class="panel-padding">
                    <div class="panel-title">
                        ...
                        <?php if($_GET['tip'] === "banka") { ?>
                            ...
                            <h3><i class="fas fa-info-circle"></i> Pogledajte <a target="_blank" href="ucp-uplatnica.php">OVDE</a> kako ispuniti uplatnicu</h3>
                        <?php }; ?>
                        ...
                        <?php } 
                         if(empty($_GET['tip'])) { ?>
                            <p>Dodajte novu uplatu! Pogledajte <a target="_blank" href="ucp-uplatnica.php">OVDE</a> kako ispuniti uplatnicu</p>
                        <?php }; ?>
                    </div>
        ...
        <form action="process.php" method="POST">
            <div class="form-input">
                <label>*<?php echo $jezik['text570']; ?></label>
                 <input name="novac" type="text" placeholder="Primer: 50.00 kn: " />
            </div>
...
<div class="new-ticket">  
            ...
            ?>
                        ...
                        <input type="hidden" name="item_name" value="Dynamic Host Payment Add Funds">
                        ...
                        <?php
                            ...
                            echo '<input type="hidden" name="notify_url" value="http://dynamic-host.xyz/paypal/paypal_payment.php" />';
                            else
                            echo '<input type="hidden" name="notify_url" value="http://dynamic-host.xyz/paypal/paypal_payment.php" />';


                        ?>
                        <input type="hidden" name="cancel_return" value="http://dynamic-host.xyz/ucp-billingadd.php?tip=paypalcancel" />
                        <input type="hidden" name="return" value="http://dynamic-host.xyz/ucp-billingadd.php?tip=paypalsuccessfunds" />

                        <input type="hidden" name="cbt" value="Back to Dynamic Hosting" />
                        <input type="hidden" name="no_note" value="1" />
                        <input type="hidden" name="no_shipping" value="1" />
                        <input type="hidden" name="cs" value="1" />
                        <input type="hidden" name="cpp_header_image" value="http://dynamic-host.xyz/assets/blue/img/logo2.png" />

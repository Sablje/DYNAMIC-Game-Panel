    ...
    <div class="main">
        <div class="document-style">
            <p>
                ...
                <p>Na korištenje web stranice Dynamic Host, u vlasništvu Dynamic Hostinga i svih njegovih dijelova, primjenjuju se ovi Uslovi korištenja.<br>
...
<p>Registrovanjem na Dynamic hosting korisnik je obavezan proći postupak registracije, unetii istinite podatke, te odabrati korisničko ime i lozinku.
...
<br>
<br>Dynamic Host zadržava pravo da ukine ili da uskrati mogućnost korištenja korisničkog računa bez prethodne najave ili/i objašnjenja.

<br>Dynamic Host ne snosi odgovornost za štetu nastalu ukidanjem korisničkog računa.
</p>
        </div>
    </div>
